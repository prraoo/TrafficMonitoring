...
def train_fn(
    ...
    for idx, (x, y) in enumerate(loop):
        ...
        with torch.cuda.amp.autocast():
            ...
            writer.add_scalar('D_loss' , D_loss)
...
def main():
    ...
    train_dataset = CityDataset(root_dir=config.TRAIN_DIR)
    ...
    for epoch in range(config.NUM_EPOCHS):
        ...
        save_some_examples(gen, val_loader, epoch, folder="evaluation")   #create a folder evaluate to store some results of validation
